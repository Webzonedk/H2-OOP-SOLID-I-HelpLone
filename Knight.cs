...
//This Class is representing the Knight and is a part of the interfaces ICharacter, IMeleeAttack, IShield
namespace HelpLone
{
    public class Knight : ICharacter, IMeleeAttack, IShield
    {
        public void Bash()
        {
